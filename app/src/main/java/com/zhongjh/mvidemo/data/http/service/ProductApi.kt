...
object ProductApi {
     ...
     * @param page 获取第几页的数据
     */
    fun getProducts(page: Int): Observable<ApiEntity<PageEntity<Product>>> =
     ...
     * @param page 获取第几页的数据
     */
    private fun simulationProducts(page: Int): Observable<ApiEntity<PageEntity<Product>>> {
        // 封装PageEntity
        ...
        return Observable.just(apiProduct).delay(1, TimeUnit.SECONDS)
    }
